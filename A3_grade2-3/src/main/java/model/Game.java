...
public class Game {
  ...
  private FactoryOfRules ruleFactory;

  /**
   * Constructor that creates a new game instance with a dealer and player.
   */
  public Game(FactoryOfRules ruleFactory) {
    this.ruleFactory = ruleFactory;
    dealer = new Dealer(ruleFactory);
    player = new Player();
  }
  ...
  /**
   * adds the observered sunjects to the game.
   */
  public void newObserver(Subject observer) {
    dealer.addObserver(observer);
    player.addObserver(observer);
  }

  public FactoryOfRules getRules() {
    return ruleFactory;
  }
